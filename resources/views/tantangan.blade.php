@php
    ...
    for ($i = 1; $i <= $jumlahSoal / 2; $i++) {
        ...
        if ($i >= 1 && $i <= 5) {
            $angka1 = rand(5, 10);
            $angka2 = rand(1, $angka1); // Menghindari hasil negatif
            $jawaban = $angka1 - $angka2;
            $pertanyaan = "$angka1 - $angka2";
        } elseif ($i >= 6 && $i <= 10) {
            $angka1 = rand(10, 20);
            $angka2 = rand(1, $angka1 - 10); // Menghindari hasil negatif
            $jawaban = $angka1 - $angka2;
            $pertanyaan = "$angka1 - $angka2";
        } elseif ($i >= 11 && $i <= 15) {
            $angka1 = rand(10, 20);
            $angka2 = rand(10, $angka1); // Menghindari hasil negatif
            $jawaban = $angka1 - $angka2;
            $pertanyaan = "$angka1 - $angka2";
        } elseif ($i >= 16 && $i <= 20) {
            $angka1 = rand(20, 40);
            $angka2 = rand(5, $angka1 - 20); // Menghindari hasil negatif
            $jawaban = $angka1 - $angka2;
            $pertanyaan = "$angka1 - $angka2";
        } else {
            $angka1 = rand(5, 20);
    ...
    // Tambahkan soal penjumlahan ke dalam array soal
    for ($i = 1; $i <= $jumlahSoal / 2; $i++) {
        $angka1 = null;
        $angka2 = null;
        $angka3 = null;
    ...
    shuffle($soal); // Mengacak seluruh array $soal
